            ...
            <svg xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 350">
                <defs>
                    <linearGradient id="gradient2" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" style="stop-color:#A3B0D4;stop-opacity:1" />
                        <stop offset="100%" style="stop-color:#E30366;stop-opacity:1" />
                    </linearGradient>
                </defs>
                <path d="M160,340c30-3,60-20,80-50c30-30,40-50,50-90c20-50,10-100-20-120c-30-20-60-20-90-30c-10-5-20-10-30-15l-1-1l-1,1c-30-10-60-5-90,5c-40,10-60,50-60,90c0,50,20,90,40,140c10,20,20,30,40,50C110,340,140,345,160,340z" fill="url(#gradient2)" />
            </svg>
        </div>
            ...
            <svg xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 350">
                <defs>
                    <linearGradient id="gradient4" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" style="stop-color:#FC9B08;stop-opacity:1" />
                        <stop offset="100%" style="stop-color:#6B948F;stop-opacity:1" />
                    </linearGradient>
                </defs>
                <path d="M150,335c30-3,60-20,80-40c30-30,40-50,50-90c15-40,10-90-20-110c-30-20-60-20-90-30c-10-5-20-10-30-15l-1-1l-1,1c-30-10-60-5-90,5c-40,10-60,50-60,90c0,50,20,90,40,140c10,20,20,30,40,50C100,340,130,340,150,335z" fill="url(#gradient4)" />
            </svg>
        </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 350">
                <defs>
                    <linearGradient id="gradient6" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" style="stop-color:#CCF00A;stop-opacity:1" />
                        <stop offset="100%" style="stop-color:#F06142;stop-opacity:1" />
                    </linearGradient>
                </defs>
                <path d="M150,340c30-3,60-20,80-50c30-30,40-50,50-90c15-30,20-65,0-100c-20-35-50-50-80-60c-10-4-20-8-30-10l-1-1l-1,1c-30-10-60-5-90,5c-40,10-60,50-60,90c0,50,20,90,40,140c10,20,20,30,40,50C100,340,130,340,150,340z" fill="url(#gradient6)" />
            </svg>
        </div>
    </div>
    <div class="slider">
